...
export default function UploadPage({
  ...
  const compactConfigurationForm = (
    <FileSettingsPanel activeConfig={activeConfig} setConfigVal={setConfigVal} isCompact={true} />
  );
  ...
  const regularConfigurationForm = (
    <FileSettingsPanel activeConfig={activeConfig} setConfigVal={setConfigVal} isCompact={false} />
  );
